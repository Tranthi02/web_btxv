...
<div class=" container1 mx-auto reset ">
    ...
    <div class="grid grid-cols-12 mt-10">
            ...
            <div class="tab-left">
                ...
                <div data-tab-content="" class="p-5">
                    <div class="block opacity-100" id="tab1" role="tabpanel">
                        <ul class="tab-left">
                            <li class="p-2"><i class="fa-solid fa-check text-sm"></i><a class="post-i fix-para" href="">Đồng chí Ngô
                                    Trí
                                    Căn – từ
                                    thành viên Nông hội đỏ đến người cán bộ lão thành cách mạng </a>
                                <br><span class="italic mt-1 text-gray-400 text-sm">(Ngày 07/09/2023)</span>
                            </li>
                            <li class="p-2"><i class="fa-solid fa-check text-sm"></i><a class="post-i fix-para" href="">Liệt sĩ Lê
                                    Đăng
                                    Thường –
                                    tấm gương cộng sản tiêu biểu của xã Ngọc Sơn, huyện Đô Lương trong phong
                                    trào Xô
                                    Viết Nghệ Tĩnh </a>
                                <br><span class="italic mt-1 text-gray-400 text-sm">(Ngày 07/09/2023)</span>
                            </li>
                            ...
                            <li class="p-2"><i class="fa-solid fa-check text-sm"></i><a class="post-i fix-para" href="">Đồng chí Võ
                                    Trọng Ân -
                                    một đường cách mạng, một lòng son </a>
                                <br><span class="italic mt-1 text-gray-400 text-sm">(Ngày 07/09/2023)</span>
                            </li>
                    ...
                    <div class="hidden opacity-0" id="tab2" role="tabpanel">
                        <ul class="post-img">
                            <li>
                                <div class="box-post">
                                    <img src="http://www.btxvnt.org.vn/images/news//NoImg.png" alt="">
                                    <p class="fix-title">Hoạt động của lãnh tụ Nguyễn Ái Quốc tại Quảng Châu và
                                        việc
                                        đào tạo thanh niên Nghệ Tĩnh xuất dương</p>
                            ...
                            <li>
                                <div class="box-post">
                                    <img src="http://www.btxvnt.org.vn/images/news//data/upload/file/dn/Image/20100506105259.jpg" alt="">
                                    <p class="fix-title">Đặng Chánh Kỷ (1890 - 1931)</p>
                            ...
                            <li>
                                <div class="box-post">
                                    <img src="http://www.btxvnt.org.vn/images/news/A6122018-144151197.jpg" alt="">
                                    <p class="fix-title">Đồng chí Tôn Gia Tinh, người chiến sỹ cộng sản trẻ tuổi
                                        -
                                        Bí thư đầu tiên của Huyện Đảng bộ Thanh Chương</p>
        ...
        <div class="sm:col-span-8 col-span-12 sm:ml-5 mx-2 border-l">
            <div class="list-video ml-2 mb-10">
                <h3 class="fix-title font-bold text-2xl ">Bảo tàng Xô Viết Nghệ Tĩnh - 60 năm hình thành và phát
                    triển</h3>

                <span class="fix-para block my-3 text-gray-500 italic"> <i class="fa-solid fa-user"></i> Người đăng: admin Ngày
                    31/05/2023</span>

                <iframe width="100%" height="350" class="" src="https://www.youtube.com/embed/I35Nw58R1UE?si=cZSCCHmosc_PQFiH" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="list-video ml-2">
                <h3 class="fix-title font-bold text-2xl ">Bảo tàng Xô Viết Nghệ Tĩnh - 60 năm hình thành và phát
                    triển</h3>
